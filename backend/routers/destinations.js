...
const DEFAULT_RECIPE_COVER_IMAGE_URL = `http://localhost:3000/images/default-destination-cover.jpg`;
...
router.post("/", async (req, res) => {
  ...
  const imageURL = image
    ...
    : DEFAULT_RECIPE_COVER_IMAGE_URL;
...
router.put("/", async (req, res) => {
  ...
  let imageURL;
  if (newImage) {
    if (destination.imageURL === DEFAULT_RECIPE_COVER_IMAGE_URL) {
