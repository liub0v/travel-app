...
export const GET_SAVED_ITEMS_COMPLETED = 'GET_SAVED_ITEMS_COMPLETED';
export const GET_SAVED_ITEMS_STARTED = 'GET_SAVED_ITEMS_STARTED';
export const GET_SAVED_ITEMS = 'GET_SAVED_ITEMS';

export const GET_VISITED_ITEMS_COMPLETED = 'GET_VISITED_ITEMS_COMPLETED';
export const GET_VISITED_ITEMS_STARTED = 'GET_VISITED_ITEMS_STARTED';
export const GET_VISITED_ITEMS = 'GET_VISITED_ITEMS';
